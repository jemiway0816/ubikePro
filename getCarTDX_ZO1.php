...
$fileTime = '/share/Web/ubike/updateTime.txt'; // 檔案名稱或路徑
$updateTime = file_get_contents($fileTime);

$filename = '/share/Web/ubike/carData.json'; // 檔案名稱或路徑
...
if ($data) {
    ...
    for ($i = 0; $i < 200; $i++) {
     ...
     echo '<tr><th>站名  ' . $updateTime . ' </th><th>車量</th><th>空柱</th></tr>';
